...
(setq initial-frame-alist
      (append '((fullscreen . maximized))
              initial-frame-alist))
(setq org-agenda-files "~/Dokumente/Agenda/*.org")
(setq package-check-signature nil)
;; Globale Tastenkombination für den Org Agenda Dispatcher
(package-initialize)
...
;; helm-git-grep package is unavailable, commented out
